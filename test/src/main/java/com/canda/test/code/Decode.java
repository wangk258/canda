...
public class Decode {
    ...
    public static void main(String[] args) throws Exception {
        System.out.println("中文to Unicode=" + chineseToUnicode("一闪一闪亮晶晶,满天都是小星星"));
        System.out.println("中文to Hex=" + toChineseHex("一闪一闪亮晶晶,满天都是小星星"));
        System.out.println("中文to GBK=" + toChineseHex("一闪一闪亮晶晶,满天都是小星星"));
        printStandardMsg(chinese2GBKHex("一闪一闪亮晶晶,满天都是小星星"));
